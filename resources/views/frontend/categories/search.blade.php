                                ...
                                <div class="product col-lg-2 col-md-2 col-sm-6 col-xs-6 margin_bottom_50">
                                    <div class="product">
                                        <div class="img-product relative">
                                            ...
                                            <a href="@if(!empty($demo)) {{route('demo.product.single',$product['sku'])}} @else  {{route('product.single',$product['sku'])}} @endif"><img
                                        ...
                                        <div class="info-product text-center">
                                            <h4 class="des-font capital title-product space_top_20"><a
                                                    href="@if(!empty($demo)) {{route('demo.product.single',$product['sku'])}} @else  {{route('product.single',$product['sku'])}} @endif">{{str_limit($product['title'],30)}}</a>
                                            </h4>
