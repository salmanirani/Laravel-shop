...
{{--                                                <a href="#">2 دیدگاه</a>--}}
                                            ...
                                            <h2 class="entry-title text-center">
                                                <a href="@if(!empty($demo)) {{route('demo.frontend.blogs.show',$post->slug)   }} @else  {{route('frontend.blogs.show',$post->slug)   }}  @endif{{route('frontend.blogs.show',$post->slug)   }}"> {{$post->title}}</a>
                                            </h2><!-- End .entry-title -->
